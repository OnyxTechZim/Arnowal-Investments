  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-brand-maroon-dark text-neutral-white clip-angle-br">
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-10 bg-linear-to-tr from-brand-maroon-dark via-brand-maroon-dark/85 to-brand-maroon/40"
        />
        ...
        <div className="hero-rise mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-gold-light">{home.hero.eyebrow}</p>
          <h1 className="mt-4 max-w-3xl font-heading text-4xl leading-[1.05] sm:text-6xl">{home.hero.headline}</h1>
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-neutral-white/85">{home.hero.valueProp}</p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button variant="light" to={home.hero.primaryCta.to}>{home.hero.primaryCta.label}</Button>
            <Button variant="outlineLight" to={home.hero.secondaryCta.to}>
