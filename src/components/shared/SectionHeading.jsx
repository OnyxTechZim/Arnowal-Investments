export default function SectionHeading({ eyebrow, title, children, align = "left", tone = "onLight" }) {
  ...
  return (
    <header className={`max-w-3xl ${alignClass}`}>
      ...
      <h2 className={`mt-2 font-heading text-3xl sm:text-4xl ${titleColor}`}>{title}</h2>
